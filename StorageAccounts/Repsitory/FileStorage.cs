...
namespace StorageAccounts.Repsitory
{
    ...
    {
        public static string connectionstring = "DefaultEndpointsProtocol=https;AccountName=niteshm003;AccountKey=eDXUiQHVgG+2k+OKWQPJ9GHQ9NdIzelQAHAkP7R2Xq5yMPQ0ot52crqfX0E+KumlVXip2Pso+6v3+ASt85Sm0g==;EndpointSuffix=core.windows.net";
